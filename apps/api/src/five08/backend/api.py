...
async def dashboard_onboarding_email_draft_handler(
    ...
    try:
        ...
        return JSONResponse(
            {"error": "crm_lookup_failed", "detail": str(exc)},
            status_code=502,
        )
...
async def dashboard_onboarding_email_send_handler(
    ...
    try:
        ...
        await _audit_dashboard_onboarding_email(
            ...
            result=AuditResult.ERROR,
            contact_id=contact_id,
            metadata={**metadata, "reason": "crm_lookup_failed", "error": str(exc)},
        )
        return JSONResponse(
            {"error": "crm_lookup_failed", "detail": str(exc)},
            status_code=502,
        ...
        await _audit_dashboard_onboarding_email(
            ...
            result=AuditResult.ERROR,
            contact_id=contact_id,
            metadata={**metadata, "reason": "email_send_failed", "error": str(exc)},
        )
        return JSONResponse(
            {"error": "email_send_failed", "detail": str(exc)},
            status_code=502,
        )
